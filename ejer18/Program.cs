 ...
 PD: Es un archivo por ejercicio*/
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<int> tiempos = new List<int>() { rd.Next(3, 6), rd.Next(3, 6), rd.Next(3, 6), rd.Next(8, 12), rd.Next(8, 12), rd.Next(8, 12) };
            List<bool> bn = new List<bool>() { false, false, false, false, false, false, false, false};
            ...
            while (true)
            {
                ...
                if (tiempoTrasncurrido.Seconds % 20 == 0 && tiempoTrasncurrido.Seconds != 0 && bn[7] == false)
                {
                    bn[7] = true;
                    paises[rd.Next(0, paises.Count - 1)].personas.Clear();
                }
                else if (!(tiempoTrasncurrido.Seconds % 20 == 0))
                {
                    bn[7] = false;
                }
            }
